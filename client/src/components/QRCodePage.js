...
const QRCodePage = () => {
  ...
  const baseUrl = `https://5000-14padu-diettracker-0yawcloo8rm.ws-us117.gitpod.io/show-person/`;

  // Fetch diet data when the component loads
  useEffect(() => {
    axios
      .get("https://5000-14padu-diettracker-0yawcloo8rm.ws-us117.gitpod.io/api/diets") // API endpoint to fetch clinic data
      .then(res => {
